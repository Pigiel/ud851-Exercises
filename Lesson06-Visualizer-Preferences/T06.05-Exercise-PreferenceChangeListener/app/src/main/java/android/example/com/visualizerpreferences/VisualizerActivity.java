...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // Updates the screen if the shared preferences change. This method is reqruired when you make a
    ...
    protected void onDestroy() {
        super.onDestroy();
        // Unregister VisualizerActivity as an OnPreferenceChagneListener to avoid any memory leaks.
